...
async def chat_server():
    # start a socket server (ne fonctionne pas avec localhost à la place de server.iiia.net)
    server = await asyncio.start_server(handle_request, 'server.iiia.net', 6666)
