...
creer_html("personnagesStarWars_template.html","personnagesSW.html",
	liste_noms=noms(liste_personnages),
	liste_femmes=femmes(liste_personnages),
    liste_droides=droides(liste_personnages),
    liste_hommes=hommes(liste_personnages),
    liste_grands=grands(liste_personnages),
    liste_persos=liste_personnages,
    )
