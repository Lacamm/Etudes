...
from mud.actions import (
    ...
    PushAction, TeleportAction, EnterAction, LeaveAction, LightOnWithAction, EatAction
)
...
def make_rules():
    ...
    return (
        ...
        (LightOnWithAction, r"allumer %s(\S+) avec %s(\w+)" % (DETS,DETS)),
