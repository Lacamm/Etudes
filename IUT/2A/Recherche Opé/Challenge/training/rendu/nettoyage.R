...
nettoyage<-function(corpus){
    motSuppr<-c(stopwords('en'),"arial","asset","background","boderpx","commentsblock","fontem","fontfamilli","fontsiz","fontsize","fontweight",
    "gtnbspnbsp","letterspacingen","lineheightem",
    "textdecor","textdecorationnon","texttransformuppercase","widthpx")
    ...
    corpus<-tm_map(corpus,removeWords,words=motSuppr)
