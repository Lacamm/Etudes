...
void display()
{
  ...
  glm::mat4 model = glm::translate(model, glm::vec3(-1.0f, 0.0f, 0.0f)) ;
  
  model = glm::rotate( glm::mat4(1.0f), glm::degrees( r ), glm::vec3(1.0f, 1.0f, 1.0f));
...
void initVAOs()
{
  ...
  std::vector<float> vertices = {
      ...
      //pour changer les couleurs, on double/triple les points et ajout couleur face
